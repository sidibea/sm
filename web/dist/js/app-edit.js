...
var $addNewItem = $('<div><a href="#" class="btn btn-info">Ajouter une nouvelle composition</a></div>');
// when the page is loaded and ready
$(document).ready(function () {
    // get the collectionHolder, initilize the var by getting the list;
    $collectionHolder = $('#compositions');
    ...
    $collectionHolder.data('index', $collectionHolder.find('.panel-header').length)
    // finds all the panels in the list and foreach one of them we add a remove button to it
    // add remove button to existing items
    $collectionHolder.find('.panel-footer').each(function () {
