...
var $addNewItem = $('<a href="#" class="btn btn-info">Ajouter une nouvelle variation</a>');
// when the page is loaded and ready
$(document).ready(function () {
    // get the collectionHolder, initilize the var by getting the list;
    $collectionHolder = $('#tab_2');
    ...
    $collectionHolder.data('index', $collectionHolder.find('.ribbon').length)
    // finds all the panels in the list and foreach one of them we add a remove button to it
    // add remove button to existing items
    $collectionHolder.find('.ribbon').each(function () {
